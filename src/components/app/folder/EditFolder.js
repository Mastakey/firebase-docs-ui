...
class EditFolderFull extends Component {
  render() {
...
EditFolderFull.propTypes = { classes: PropTypes.object.isRequired, error: PropTypes.object.isRequired };

const mapStateToProps = state => ({});

export default connect(mapStateToProps, null)(withStyles(styles)(EditFolderFull));
